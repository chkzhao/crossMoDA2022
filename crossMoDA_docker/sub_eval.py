...
from utils.utils import InstanceNormalizeIntensityd
...
def set_and_get_model():
    ...
    model_dict = torch.load('./159_epoch_model.pth')
    ...
    zoom_model_dict = torch.load('./159_epoch_zoom_model.pth')
...
input_dir = './resample'
path_img = os.path.join(input_dir,'crossmoda{}_hrT2.nii.gz')
# path_pred = '/output/crossmoda{}_Label.nii.gz'

list_case = [k[9:21] for k in os.listdir(input_dir)]
