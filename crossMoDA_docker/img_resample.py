...
ref_img = sitk.ReadImage('。/crossmoda2021_ldn_106_hrT2.nii.gz')
#
save_path = './resample'
if not os.path.exists(save_path):
    os.mkdir(save_path)

input_dir = '../../../dataset/validation/validation'
path_img = os.path.join(input_dir,'crossmoda{}_hrT2.nii.gz')
list_case = [k[9:21] for k in os.listdir(input_dir)]

for i in list_case:
    img = sitk.ReadImage(os.path.join(input_dir,'crossmoda'+ i +'_hrT2.nii.gz'))
    ...
    save_name = 'crossmoda'+ i +'_hrT2.nii.gz'
