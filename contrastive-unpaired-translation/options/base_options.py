...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_minimum', type=float, default=0.001, help='weight for cycle loss (B -> A -> B)')
        parser.add_argument('--theta_mix', action='store_true', help='weight for cycle loss (B -> A -> B)')
        # model parameters
